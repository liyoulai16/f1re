<template>
    <div>
        <div class="mb-8">
            <router-link to="/admin/articles" class="text-indigo-600 hover:text-indigo-700 text-sm font-medium transition-colors">
                &larr; 返回博客管理
            </router-link>
            <h1 class="text-2xl font-bold text-gray-900 mt-4">{{ isEdit ? '编辑文章' : '新建文章' }}</h1>
        </div>
...
import { createAdminArticle, updateAdminArticle, getAdminArticle } from '../../api';
